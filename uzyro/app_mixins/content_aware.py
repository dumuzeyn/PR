...
class ContentAwareMixin:
    ...
    def content_aware_fill_dialog(self, selection_mask: np.ndarray) -> dict[str, object] | None:
        ...
        AccentScale(controls, variable=brush_size, from_=8, to=180).pack(fill=tk.X)
        ...
        AccentScale(controls, variable=radius, from_=1, to=30).pack(fill=tk.X)
        ...
        AccentScale(controls, variable=color_adaptation, from_=0.0, to=1.0).pack(fill=tk.X)
