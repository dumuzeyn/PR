...
- non-destructive per-layer filter stack with a visual editor, preview, reorder controls, per-filter enable/opacity and blur, sharpen, noise, median, edge and emboss filters
