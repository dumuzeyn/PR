...
- real selection mask with select all, invert, feather, smooth, grow, shrink, border/refine, opaque-pixel selection, single row/column selection and saved alpha selections
