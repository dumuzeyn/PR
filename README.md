...
- real selection mask with select all, invert, feather, smooth, grow, shrink, border/refine, smart edge cleanup, subject selection, richer Select and Mask previews/output, opaque-pixel selection, single row/column selection, magnetic edge snapping and saved alpha selections
