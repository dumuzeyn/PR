...
- non-destructive per-layer filter stack with a visual editor, preview, reorder controls, per-filter enable/opacity/blend modes/masks and blur, sharpen, noise, median, edge and emboss filters
