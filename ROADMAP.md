...
- Raster layer masks: reveal all, hide all, from selection, mask thumbnails, linked/unlinked movement, paint on mask, density, feather, invert, toggle, apply, delete.
...
2. Editable masks: richer mask preview controls and mask-channel editing polish.
