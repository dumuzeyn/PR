...
- Non-destructive filters: per-layer editable filter stack with visual editor, presets, preview, reordering, per-filter enable/opacity/blend modes/masks, blur, sharpen, noise, median, edge detect and emboss.
...
3. Non-destructive editing: richer editable adjustment controls and reusable external filter-stack preset files.
