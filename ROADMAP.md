...
- Raster layer masks: reveal all, hide all, from selection, linked/unlinked movement, paint on mask, density, feather, invert, toggle, apply, delete.
...
2. Editable masks: mask thumbnails and richer mask preview controls.
