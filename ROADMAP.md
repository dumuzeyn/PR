...
- Raster selections: rectangular, elliptical, freehand lasso, magnetic lasso, polygon lasso, quick selection brush, magic wand, color range, single row/column, opaque pixels, select all, invert, feather, smooth, grow, shrink, border/refine, richer Select and Mask previews/output, saved alpha selections.
...
1. Selection engine: better quick-selection refinement and smarter edge-aware selection cleanup.
